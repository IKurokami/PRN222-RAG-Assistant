        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IndexError = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("d50db4a1-a8b1-4f49-9c43-89d78be62511"), "PRN222", true, "PRN222" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Chapters_SubjectId_Number",
                table: "Chapters",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatSessions_UserId_UpdatedAtUtc",
                table: "ChatSessions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageCitations_ChatMessageId_DocumentChunkId",
                table: "MessageCitations",
                columns: new[] { "ChatMessageId", "DocumentChunkId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MessageCitations_ChatMessageId_Rank",
                table: "MessageCitations",
                columns: new[] { "ChatMessageId", "Rank" },
                unique: true);
